...
int main()
{
   ...
   //The increment operator is used to increase a variable. It is denoted by the symbol ++. It is a unary operator
   // and works with single variable. it increment variable by 1;
